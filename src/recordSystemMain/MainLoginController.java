 ...
 *	This class checks for the credentials of each actor logins
 */
            ...
            switch (userType){
                case "Admin":
                    if (isValidCredentials(userType,userName,password,"Email")){
                        try {
                            Parent adminParent = FXMLLoader.load(getClass().getResource("/admin/Admin1.fxml"));
                ...
                case "Teacher":
                    if (isValidCredentials(userType,userName,password,"ID")){
                        try {
                            ...
                            teacherController.setID(userName);
